...
def _build_atom_cache():
    ...
    common_symbols = [
        ...
        "[#P-1]", "[#P]", "[#S+1]", "[#S-1]", "[#S]", "[/Br]", "[/C@@H1]",
        "[/C@@]", "[/C@H1]", "[/C@]", "[/C]", "[/Cl]", "[/F]", "[/N+1]",
        "[/N-1]", "[/NH1+1]", "[/NH1-1]", "[/NH1]", "[/NH2+1]", "[/N]",
        "[/O+1]", "[/O-1]", "[/O]", "[/S-1]", "[/S@]", "[/S]", "[=C+1]",
        "[=C-1]", "[=C]", "[=N+1]", "[=N-1]", "[=NH1+1]", "[=NH2+1]", "[=N]",
        "[=O+1]", "[=OH1+1]", "[=O]", "[=P+1]", "[=P-1]", "[=P@@]", "[=P@]",
        "[=PH2]", "[=P]", "[=S+1]", "[=S-1]", "[=S@@]", "[=S@]", "[=SH1+1]",
        "[=S]", "[Br]", "[C+1]", "[C-1]", "[C@@H1]", "[C@@]", "[C@H1]", "[C@]",
        "[CH1-1]", "[CH2-1]", "[C]", "[Cl]", "[F]", "[H]", "[I]", "[N+1]",
        "[N-1]", "[NH1+1]", "[NH1-1]", "[NH1]", "[NH2+1]", "[NH3+1]", "[N]",
        "[O+1]", "[O-1]", "[O]", "[P+1]", "[P-1]", "[P@@H1]", "[P@@]", "[P@]",
        "[PH1+1]", "[PH1]", "[P]", "[S+1]", "[S-1]", "[S@@+1]", "[S@@]",
        "[S@]", "[S]", "[\\Br]", "[\\C@@H1]", "[\\C@H1]", "[\\C]", "[\\Cl]",
        "[\\F]", "[\\I]", "[\\N+1]", "[\\N-1]", "[\\NH1+1]", "[\\NH1]",
        "[\\NH2+1]", "[\\N]", "[\\O-1]", "[\\O]", "[\\S-1]", "[\\S@]", "[\\S]"
    ]
