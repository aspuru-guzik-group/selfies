...
__all__ = ['encoder', 'decoder',
           ...
           'selfies_to_hot', 'multiple_selfies_to_hot', 'hot_to_selfies',
...
from .utils import get_alphabet_from_selfies, len_selfies, split_selfies, selfies_to_hot, multiple_selfies_to_hot, hot_to_selfies, multiple_hot_to_selfies
